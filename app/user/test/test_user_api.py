...
class PublicUserApiTests(TestCase):
    ...
    def test_create_valid_user_sucess(self):
        """Test creating user when valid payload is sucessfully"""
        payload={
    ...
    def test_password_too_short(self):
        """Test that password is more that 5 letters"""
        payload={
            'email': 'test@email.com',
            'password' : '12',
        }
    ...
    def test_create_token_invalid_credential(self):
        ...
        create_user(email='test@email.com', password='test')
        payload ={'email':'testfghh@email.com', 'password':'tehtest'}
        res = self.client.post(TOKEN_USER_URL,payload)
    ...
    def test_create_token_missing_field(self):
            ...
            res = self.client.post(TOKEN_USER_URL,{'email':'test', 'password':''})
            self.assertNotIn('token',res.data)
            self.assertEqual(res.status_code,status.HTTP_400_BAD_REQUEST)
...
class PrivateUserApiTests(TestCase):
    ...
    def test_updating_user_profile(self):
        ...
        payload ={'password':'tehtest', 'name':'favour'}
